...
if __name__ == '__main__':
    ...
    parser.add_argument('--eva_seqs',   type=str, default='00_pred,02_pred,03_pred,04_pred,05_pred,06_pred,07_pred,08_pred,09_pred,10_pred', help='The sequences to be evaluated') 
